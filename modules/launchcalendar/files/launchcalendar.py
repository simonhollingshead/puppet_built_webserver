...
for element in relevant_elements:
    if "datename" in element["class"]:
        ...
        launch_date = element.findAll(class_="launchdate")[0].text
        if ("Sept" in launch_date) and ("September" not in launch_date):
            launch_date = launch_date.replace("Sept", "Sep")
...
cal.add("prodid", "-//Simon Hollingshead//Launch Calendar//EN")
...
with open("/srv/www/launchcalendar/launchcal.ics", "wb", int("0644", 8)) as f:
    f.write(cal.to_ical())
